...
SRC_GROUP = "_unknown_id_ocaml_stdlib"
FLAT_PREFIX = "unknown_id_ocaml_stdlib"
...
; _unknown_id_ocaml_stdlib/a _> unknown_id_ocaml_stdlib_a
; _unknown_id_ocaml_stdlib/b _> unknown_id_ocaml_stdlib_b
; ...\
""")
    print()
    for name in entries:
        flat = f"{FLAT_PREFIX}_{name}"
        out = f"""\
(subdir {flat}
 (copy_files
